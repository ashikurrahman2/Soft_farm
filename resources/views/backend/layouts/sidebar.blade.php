    ...
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="{{ route('admin.dashboard') }}" class="b-brand text-primary">
                ...
                <span class="badge bg-primary rounded-pill ms-2 theme-version">CodeXilium Ltd</span>
            </a>
        </div>
                ...
                <div class="pc-user-collpsed collapse" id="navuserlink">
                    ...
                    <ul>
                        ...
                        <li><a class="pc-user-links"><i class="ph-duotone ph-lock-key"></i> <span>Lock
                                    Screen</span></a></li>
                        <li><a href="{{ route('logout') }}" class="pc-user-links"><i class="ph-duotone ph-power"></i>
                                <span>Logout</span></a>
                        </li>
                    </ul>
                </div>
            ...
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link">
                        ...
                        <span class="pc-mtext">About Office</span>
                        <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
                    </a>
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link" href="{{ route('aboutoffice.index') }}">About</a>
                        </li>
                         {{-- <li class="pc-item"><a class="pc-link" href="{{ route('subcategory.index') }}">Subcategories</a>
                        </li> --}}
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link" href="{{ route('client.index') }}">Add service & client</a>
                        </li>
                        {{-- <li class="pc-item"><a class="pc-link" href="{{ route('product.index') }}">Manage Product</a>
                        </li> --}}
                    </ul>
                </li>
                {{-- <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        ...
                        <li class="pc-item"><a class="pc-link" href="{{ route('campaing.index') }}">E Campaing</a>
                        </li>
                    </ul>
                </li> --}}
                {{-- <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link" href="{{ route('pickuppoint.index') }}">Pickup
                                Point</a>
                        </li>
                    </ul>
                </li> --}}
                {{-- <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link" href="{{ route('seo.index') }}">SEO Setting</a>
                        </li>
                        ...
                        <li class="pc-item"><a class="pc-link" href="{{ route('contact.index') }}">Contact</a>
                        </li>
                        <li class="pc-item"><a class="pc-link" href="{{ route('brand.index') }}">Payment Gateway</a>
                        </li>
                    </ul>
                </li>  --}}
                    </ul>
                    <div class="card nav-action-card">
                        <div class="card-body">
                            ...
                            <p class="text-white text-opacity-75">Please contact us for more questions.</p><a
                                target="_blank" href="https://phoenixcoded.authordesk.app/" class="btn btn-primary">Go
                                to
                                help Center</a>
                        </div>
                    </div>
