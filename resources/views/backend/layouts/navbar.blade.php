    ...
    <div class="header-wrapper">
        ...
        <div class="me-auto pc-mob-drp">
            <ul class="list-unstyled">
                ...
                <li class="dropdown pc-h-item"><a class="pc-head-link dropdown-toggle arrow-none m-0 trig-drp-search"
            ...
            <ul class="list-unstyled">
                <li class="dropdown pc-h-item"><a class="pc-head-link dropdown-toggle arrow-none me-0"
                    ...
                    <div class="dropdown-menu dropdown-menu-end pc-h-dropdown"><a href="#!" class="dropdown-item"
                            ...
                            class="dropdown-item" onclick="layout_change_default()"><i class="ph-duotone ph-cpu"></i>
                ...
                <li class="dropdown pc-h-item"><a class="pc-head-link dropdown-toggle arrow-none me-0"
                    ...
                    <div class="dropdown-menu dropdown-menu-end pc-h-dropdown"><a href="#!"
                            ...
                            href="#!" class="dropdown-item"><i class="ph-duotone ph-gear"></i>
                ...
                <li class="dropdown pc-h-item header-user-profile"><a
                        ...
                        role="button" aria-haspopup="false" data-bs-auto-close="outside" aria-expanded="false"><img
                            src="{{ asset('/') }}admin/assets/images/user/avatar-2.jpg" alt="user-image"
                            class="user-avtar"></a>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 mx-3">
                                                <h5 class="mb-0">{{ Auth::user()->name }}</h5><a
                                                    class="link-primary"
