                ...
                <div class="col-xxl-6 col-md-12">
                    <div class="card flat-card">
                        <div class="row-table">
                            ...
                            <div class="col-sm-6 card-body br">
                                <div class="row">
                                    <div class="col-4"><i class="material-icons-two-tone text-primary mb-1">unarchive</i>
                                    </div>
                                    <div class="col-8 text-md-center">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover m-b-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>HeadPhone</td>
                                                <td><img src="{{ asset('/') }}admin/assets/images/widget/p1.jpg"
                                                        alt="" class="img-20">
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>Iphone 6</td>
                                                <td><img src="{{ asset('/') }}admin/assets/images/widget/p2.jpg"
                                                        alt="" class="img-20">
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>Jacket</td>
                                                <td><img src="{{ asset('/') }}admin/assets/images/widget/p3.jpg"
                                                        alt="" class="img-20">
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>Sofa</td>
                                                <td><img src="{{ asset('/') }}admin/assets/images/widget/p4.jpg"
                                                        alt="" class="img-20">
                                                </td>
                                                <td>
                                                    <div><label class="badge bg-light-danger">Cancel</label></div>
                            ...
                            <div class="card prod-p-card bg-purple-500 card-border-none">
                                <div class="card-body">
                                    <div class="row align-items-center m-b-0">
                                        ...
                                        <div class="col-auto"><i class="material-icons-two-tone text-white">local_mall</i>
                                        </div>
                                    </div>
                                </div>
                            </div>
